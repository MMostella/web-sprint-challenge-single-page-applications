...
- [1] A homepage that has a "/" route and links to your form (button, nav bar, or any other type of link is acceptable but must have an id of "order-pizza")
- [1] A order form that has a "/pizza" route and shows the form
- [1] A form with an id of "pizza-form"
- [1] A name text input field with an id of "name-input"
- [1] Validation for name and the error message is "name must be at least 2 characters" (Use this exact error message to make sure tests pass)
- [1] A dropdown for pizza size with an id of "size-dropdown"
- [1] A checklist for toppings - at least 4 (hint: name each separately!)
- [1] Text input for special instructions with an id of "special-text"
- [1] An Add to Order button that has an id of "order-button" and that submits form and returns a database record of name, size, toppings and special instructions
